...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($newPassword)) {
        ...
        if ($updateStmt->execute()) {
            ...
            $confirmPasswordErr = "Error updating password. Please try again.";
        }
        $updateStmt->close();
    }
}
...
<head>
    ...
    <title>Olog - Reset Password</title>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="account-sign-in">
                            ...
                            <?php if ($resetSuccess): ?>
                                <p style="color: green;">Password has been reset successfully. <a href="account (1).php">Login here</a>.</p>
                            <?php else: ?>
                            <form action="reset-password.php?email=<?php echo urlencode($email); ?>" method="POST">
                                <div class="form__div">
                                <input type="hidden" name="Ceekemail" value="<?php echo htmlspecialchars($email); ?>">
                                    <input type="password" class="form__input" placeholder=" " name="newPassword">
                                    <label for="" class="form__label">New Password</label>
                                </div>
                                <div class="form__div mb-0">
                                    <span style="color:red"><?echo $passwordErr;?></span>
                                ...
                                <span style="color:red"><?echo $confirmPasswordErr;?></span>
                                <div class="password-info-show">
                                    <input type="checkbox" id="showpassagain" class="mb-0" name="showpassword">
                                    <label for="showpassagain" class="mb-0">Show Password</label>
                                </div>
                                <button href="#" class="btn bg-primary">Reset Password</button>
                            </form>
                            <?php endif; ?>
