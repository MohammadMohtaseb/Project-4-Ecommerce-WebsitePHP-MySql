...
<body>
    ...
    <script>
        ...
        function addToCart(event, productId) {
            ...
            fetch('http://localhost/ecommercebreifdb/cartAction.php', {
                    method: 'POST',
                    body: formData
                })
        ...
        function removeFromWishlist(event, productId) {
            ...
            fetch('http://localhost/ecommercebreifdb/wishlistAction.php', {
                    method: 'POST',
                    body: formData
                })
                .then(responsedel => responsedel.json())
                .then(data => {
                    if (data.status === 'success') {
        ...
        window.onload = function() {
            fetch('http://localhost/ecommercebreifdb/cartAction.php?action=get_cart_count')
                .then(response => response.json())
                .then(data => {
                    if (data.status === 'success') {
                        updateCartCount(data.cart_count);
