                    ...
                    <div class="body">
                        ...
                        ?>
                                    <div class="item" data-product-id="<?php echo $product_id; ?>">
                                        ...
                                        <div class="total">
                                            <span class="total-price"><?php echo 'JD' . number_format($totalPrice, 2); ?></span>
                                        </div>
                                    </div>
                        <?php
                                }
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <!-- <div class="card-price">
                        ...
                        <form action="#">
                            <a href="billing-information.php" class="btn bg-primary" type="submit" style="width: 100%;">Checkout Now</a>
                        </form>
                    </div> -->
                </div>
            </div>
